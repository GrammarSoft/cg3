...
cd gcov/
#head -n 3000 arboretum_stripped.txt | ../src/vislcg3 -v -C UTF-8 -g ../dancg.cg3b > out1.txt
head -n 3000 arboretum_stripped.txt | ./vislcg3 -v -C UTF-8 -g ../dancg.cg3b > out2.txt
...
cd ../gprof/
head -n 3000 arboretum_stripped.txt | ./vislcg3 -v -C UTF-8 -g ../dancg.cg3b > out3.txt
