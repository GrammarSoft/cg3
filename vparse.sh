...
rm -f callgrind.*
rm -f annotated
g++ -DHAVE_BOOST -I~/tmp/boost_1_47_0 -Wall -Wextra -Wno-deprecated -pipe -O3 -g3 -fno-rtti -ffor-scope -L/usr/local/lib -ltcmalloc -licuio -licuuc ../src/all_vislcg3.cpp -o vislcg3.debug
