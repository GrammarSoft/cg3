...
rm -f callgrind.*
rm -f annotated
g++ -DHAVE_BOOST -I~/tmp/boost_1_46_1 -Wall -Wextra -Wno-deprecated -pipe -O3 -g3 -fno-rtti -ffor-scope -ltcmalloc -licuio -licuuc ../src/all_vislcg3.cpp -o vislcg3.debug
