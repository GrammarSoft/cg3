...
namespace Options {
	...
	UOption options[]= {
		...
		UOPTION_DEF_D("in-matxin",			'm', UOPT_NO_ARG, "sets input format to Matxin"),
		...
		UOPTION_DEF_D("out-cg",				0, UOPT_NO_ARG, "sets output format to CG (default)"),
		UOPTION_DEF_D("out-apertium",		0, UOPT_NO_ARG, "sets output format to Apertium"),
		UOPTION_DEF_D("out-matxin",			0, UOPT_NO_ARG, "sets output format to Matxin"),
