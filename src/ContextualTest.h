...
namespace CG3 {
	...
	enum {
		...
		MASK_POS_DEP       = POS_DEP_PARENT|POS_DEP_SIBLING|POS_DEP_CHILD|POS_DEP_DESCENDENT,
		...
		MASK_POS_SCAN      = POS_SCANFIRST|POS_SCANALL|POS_DEP_DEEP|POS_SUB_SCANFIRST|POS_SUB_SCANALL|POS_DEP_DESCENDENT,
	};
