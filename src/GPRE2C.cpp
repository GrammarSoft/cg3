/* Generated by re2c 0.11.0 on Thu Mar  8 15:57:08 2007 */
/*
...
YYCTYPE *GPRE2C::re2c_skipline(YYCTYPE *input) {
skipline_start:
...
YYCTYPE *GPRE2C::re2c_parseCompositeTag(YYCTYPE *input, Set *set) {
...
YYCTYPE *GPRE2C::re2c_parseInlineSet(YYCTYPE *input, Set **ret_set) {
...
YYCTYPE *GPRE2C::re2c_parseSetList(YYCTYPE *input, Set *set) {
	bool want_set = true;
	marker = YYCURSOR;
...
YYCTYPE *GPRE2C::re2c_parseTagList(YYCTYPE *input, Set *set) {
	marker = YYCURSOR;
...
YYCTYPE *GPRE2C::re2c_parseDelimiters(YYCTYPE *input, STRINGS which) {
	CG3::Set *curset = result->allocateSet();
...
YYCTYPE *GPRE2C::re2c_parseList(YYCTYPE *input) {
	marker = YYCURSOR;
	CG3::Set *curset = result->allocateSet();
	curset->line = result->lines;
...
YYCTYPE *GPRE2C::re2c_parseSet(YYCTYPE *input) {
	marker = YYCURSOR;
	CG3::Set *curset = result->allocateSet();
	curset->line = result->lines;
	if (result->lines == 1333) {
...
YYCTYPE *GPRE2C::re2c_parsePreferredTargets(YYCTYPE *input) {
	marker = YYCURSOR;
...
KEYWORDS GPRE2C::re2c_scan(YYCTYPE *input) {
...
int GPRE2C::re2c_grammar_from_ufile(UFILE *input) {
	u_frewind(input);
	if (u_feof(input)) {
