...
int main(int argc, char* argv[]) {
	...
	std::cerr << "Grammar has " << grammar->sections.size() << " sections, " << grammar->template_list.size() << " templates, " << grammar->rule_by_line.size() << " rules, " << grammar->sets_by_contents.size() << " sets, " << grammar->single_tags.size() << " tags." << std::endl;
