...
std::array<UOption,NUM_OPTIONS> options{
	...
	UOPTION_DEF_D("nrules",                0, UOPT_REQUIRES_ARG, "a regex for which rule names to parse/run; defaults to all rules"),
	UOPTION_DEF_D("nrules-v",              0, UOPT_REQUIRES_ARG, "a regex for which rule names not to parse/run"),
