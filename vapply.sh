...
rm -fv callgrind.*
rm -fv annotated
g++ -DHAVE_BOOST -I~/tmp/boost_1_46_1 -pipe -Wall -Wextra -Wno-deprecated -O3 -g3 -fno-rtti -ffor-scope -ltcmalloc -licuio -licuuc ../src/all_vislcg3.cpp -o vislcg3.debug
